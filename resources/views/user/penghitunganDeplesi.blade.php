...
<br><br>
      <div class="section-title">
        <p>Penghitungan</p>
          ...
          <br>
          <div class="desc">
            <p>Deplesi adalah penyusutan jumlah ayam yang disebabkan oleh kematian maupun karena afkir.
            </p>
          </div><br><br>
          <form class="row justify-content-center ps-4" >
            ...
            <div class="col-md-4 ps-5">
                <label for="basic-url" class="form-label">Jumlah ayam mati atau afkir</label>
