                        ...
                        <div class="col-lg-12">
                            <div class="title-all">
                                  ...
                                  <a href="/" class="btn btn-default btn-sm"><i class="nav-icon fas fa-arrow-left"></i> &nbsp; Kembali</a>
                                    <div class="col-lg-12">
                                        <div class="title-all text-center">
                                                <h3 style="font-weight: 700;"><td>Virus ND</td></h3>
                                                <br>
                                ...
                                <h4 style="font-weight: 700;">Tentang Penyakit</h4><br>
                                        ...
                                        Tetelo (virus ND) adalah penyakit yang menular yang disebabkan oleh virus ND. Faktor 
                                        kebersihan kandang, pencahayaan matahari dan sirkulasi udara yang tidak baik juga dapat 
                                        berpengaruh.
                                        </td></p>
                                        <br>
                                <br>
                                <h4 style="font-weight: 700;">Gejala-Gejala</h4><br>
                                        <p style="padding-left: 25px;"><td>
                                        Mengalami bersin-bersin, ngorok, batuk dan juga nafasnya tersendat, tidak bertenaga, mata 
                                        ayam terlihat keruh dan jenggernya berubah warna menjadi biru
                                        </td></p>
                                        <br>
                                        <br>
                                <h4 style="font-weight: 700;">Obat dan Penanganan</h4><br>
                                        ...
                                        kondisi badan ayamcepat membaik dan merangsang nafsu makannya dengan memberikan tambahan 
                                        vitamin dan mineral, serta mencegah infeksi sekunder dengan pemberian antibiotik. Dapat pula 
